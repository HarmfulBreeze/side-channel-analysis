...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        choices=["stm32f4discovery", "nucleo-l476rg", "nucleo-l4r5zi", "cw308t-stm32f3", "cw308t-stm32f4", "mps2-an386"],
...
def get_platform(args):
    ...
    elif args.platform == "cw308t-stm32f3" or args.platform == "cw308t-stm32f4":
        bin_type = 'hex'
